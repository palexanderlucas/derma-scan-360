          ...
          <div className="container mx-auto px-3 sm:px-4">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 max-w-6xl mx-auto">
              <div className="group bg-card p-4 sm:p-6 rounded-xl border text-center hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer">
                ...
                <h3 className="font-semibold sm:text-base mb-2 text-base text-center">
...
    <br />Kosten senken
              ...
              <div className="group bg-card p-4 sm:p-6 rounded-xl border text-center hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer">
                ...
                <h3 className="font-semibold sm:text-base mb-2 text-base">Krankheitsausfälle und Frühberentung vermeiden</h3>
              </div>
              <div className="group bg-card p-4 sm:p-6 rounded-xl border text-center hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer">
                ...
                <h3 className="font-semibold sm:text-base mb-2 text-base">Mitarbeiterbindung und -zufriedenheit stärken</h3>
              </div>
              <div className="group bg-card p-4 sm:p-6 rounded-xl border text-center hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer">
                ...
                <h3 className="font-semibold sm:text-base mb-2 text-base">Gesundes Arbeitsumfeld – hohe Attraktivität</h3>
              </div>
            </div>
          </div>
        </section>
