      ...
      <main className="pt-16 sm:pt-20">
        ...
        <section id="angebot" className="py-12 sm:py-16 md:py-20">
          <div className="container mx-auto px-3 sm:px-4">
            ...
            <p className="text-center text-muted-foreground mb-10 sm:mb-12 max-w-3xl mx-auto text-lg">​Gesunde, motivierte Mitarbeitende treiben den Erfolg Ihres Unternehmens voran. Für Ihr Unternehmen entwickeln wir eine passgenaue BGM-Lösung - stets individuell auf Ihre Bedürfnisse angepasst - nahtlos inden unternehnerischen Alltag integriert.                                                    </p>
            <div className="max-w-4xl mx-auto space-y-6">
              <div className="bg-card p-6 sm:p-8 rounded-xl border">
