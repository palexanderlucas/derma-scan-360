...
const benefitsCards = [
  { icon: TrendingUp, title: "Produktivität steigern\nKosten senken" },
  { icon: Shield, title: "Krankheitsausfälle und\nFrühberentung vermeiden" },
  { icon: Users, title: "Mitarbeiterbindung und\n-zufriedenheit stärken" },
  { icon: Heart, title: "Gesundes Arbeitsumfeld\nhohe Attraktivität" },
];
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="pt-16 sm:pt-20">
            ...
            <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 items-center">
              <div className="text-left">
                ...
                <p className="text-base sm:text-lg md:text-xl text-muted-foreground mb-6 sm:mb-8">
                  Machen Sie mit DermaScan360 Hautkrebsvorsorge auch für Ihre Mitarbeiter einfach und zugänglich. Wir bieten maßgeschneiderte Lösungen, ob in unserer Filiale oder direkt vor Ort in Ihrem Unternehmen – wir freuen uns über einen Austausch!
                </p>
                <Button size="lg" onClick={() => scrollToSection("kontakt")} className="gap-3 justify-start w-fit">
            ...
            <div className="max-w-3xl mx-auto flex flex-col gap-6 sm:gap-8">
              ...
              <div className="bg-card p-6 sm:p-8 rounded-xl border">
                ...
                <ul className="space-y-3 text-muted-foreground">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-primary mt-[0.3em] leading-none">•</span>
                    <span>Schwerbehinderung ab 1. Stadium (GdB 50-80%)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary mt-[0.3em] leading-none">•</span>
        ...
        {/* Unser Angebot */}
        <section id="angebot" className="py-12 sm:py-16 md:py-20 bg-muted/60">
          <div className="container mx-auto px-3 sm:px-4">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-4">
              Unser Angebot für Ihr Unternehmen
            </h2>
            <p className="text-center text-muted-foreground mb-10 sm:mb-12 max-w-3xl mx-auto text-base">
            ...
            <div className="max-w-4xl mx-auto space-y-6">
              ...
              <div className="bg-card p-6 sm:p-8 rounded-xl border">
                ...
                <p className="text-muted-foreground">
                  fachärztliches Total-Body-Mapping mit Auflichtmikroskop vor Ort in Ihrem Unternehmen
                </p>
              </div>
              <div className="bg-card p-6 sm:p-8 rounded-xl border">
                <div className="flex items-center gap-3 mb-2">
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="mt-8 text-center">
                ...
                <p className="font-semibold">
                  E-Mail:{" "}
                  <a href="mailto:kontakt@dermascan360.de" className="text-primary hover:underline">kontakt@dermascan360.de</a>
                </p>
              </div>
            </div>
          </div>
