...
export const WalkInDialog = ({ open, onOpenChange }: WalkInDialogProps) => {
  return (
    <InfoDialog open={open} onOpenChange={onOpenChange} title="Angebot bald verfügbar">
      <p>
        Wir eröffnen voraussichtlich am <strong>01.03.2026</strong>. Das Angebot gilt ab Eröffnung zu unseren Öffnungszeiten. Informationen zu den Öffnungszeiten folgen in Kürze.
      </p>
      <p>
