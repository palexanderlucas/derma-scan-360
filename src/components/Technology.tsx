        ...
        <div className="space-y-12 sm:space-y-16 md:space-y-20 lg:space-y-28 xl:space-y-36">
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-14 xl:gap-20 items-center">
            <div className="space-y-4 sm:space-y-5 lg:space-y-6 max-w-2xl">
              ...
              <div className="relative lg:hidden">
                ...
                <LazyImage src={bodyScanner} alt="Total-Body-Mapping Scanner" className="relative rounded-xl sm:rounded-2xl shadow-xl w-full" />
              </div>
            ...
            <div className="relative hidden lg:block">
              <div className="absolute -inset-1 sm:-inset-2 bg-gradient-to-br from-primary/20 to-accent/10 rounded-2xl sm:rounded-3xl blur-xl sm:blur-2xl opacity-50"></div>
              <LazyImage src={bodyScanner} alt="Total-Body-Mapping Scanner" className="relative rounded-xl sm:rounded-2xl lg:rounded-3xl shadow-xl w-full" />
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-14 xl:gap-20 items-center">
            <div className="relative order-2 lg:order-1 hidden lg:block">
              <div className="absolute -inset-1 sm:-inset-2 bg-gradient-to-br from-primary/20 to-accent/10 rounded-2xl sm:rounded-3xl blur-xl sm:blur-2xl opacity-50"></div>
              <LazyImage src={dermatoscope} alt="Digitale Auflichtmikroskopie" className="relative rounded-xl sm:rounded-2xl lg:rounded-3xl shadow-xl w-full" />
            </div>
            <div className="space-y-4 sm:space-y-5 lg:space-y-6 order-1 lg:order-2 max-w-2xl">
              ...
              <div className="relative lg:hidden">
                <div className="absolute -inset-1 sm:-inset-2 bg-gradient-to-br from-primary/20 to-accent/10 rounded-2xl sm:rounded-3xl blur-xl sm:blur-2xl opacity-50"></div>
                <LazyImage src={dermatoscope} alt="Digitale Auflichtmikroskopie" className="relative rounded-xl sm:rounded-2xl shadow-xl w-full" />
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-14 xl:gap-20 items-center">
            <div className="space-y-4 sm:space-y-5 lg:space-y-6 max-w-2xl">
              ...
              <div className="relative lg:hidden">
                <div className="absolute -inset-1 sm:-inset-2 bg-gradient-to-br from-primary/20 to-accent/10 rounded-2xl sm:rounded-3xl blur-xl sm:blur-2xl opacity-50"></div>
                <LazyImage src={doctorAnalysis} alt="Qualitätssicherung durch Hautarzt" className="relative rounded-xl sm:rounded-2xl shadow-xl w-full" />
              </div>
            ...
            <div className="relative hidden lg:block">
              <div className="absolute -inset-1 sm:-inset-2 bg-gradient-to-br from-primary/20 to-accent/10 rounded-2xl sm:rounded-3xl blur-xl sm:blur-2xl opacity-50"></div>
              <LazyImage src={doctorAnalysis} alt="Qualitätssicherung durch Hautarzt" className="relative rounded-xl sm:rounded-2xl lg:rounded-3xl shadow-xl w-full" />
            </div>
          </div>
        </div>
      </div>
