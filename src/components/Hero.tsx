  ...
  return <section className="pt-20 pb-12 sm:pt-24 sm:pb-16 md:pt-32 md:pb-20 lg:pt-44 lg:pb-28 xl:pt-52 xl:pb-36 bg-gradient-to-b from-accent/40 via-accent/20 to-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-3 sm:px-4 lg:px-8 xl:px-12 relative max-w-[1600px]">
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 md:gap-10 lg:gap-14 xl:gap-20 lg:items-center">
          ...
          <div className="relative group mt-6 lg:mt-0 order-2">
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between gap-4 sm:gap-5 pt-6 sm:pt-8 border-t border-border/50 lg:hidden order-3">
            <div className="flex items-center gap-2.5 sm:gap-3 group">
              <div className="p-2 sm:p-2.5 bg-primary/10 rounded-lg sm:rounded-xl group-hover:bg-primary/15 transition-colors duration-200 flex-shrink-0">
                <Clock className="h-5 w-5 sm:h-6 sm:w-6 text-primary" />
              </div>
              <div className="min-w-0">
                <div className="font-semibold text-xs sm:text-sm whitespace-nowrap">Termingarantie</div>
                <div className="text-[10px] sm:text-xs text-muted-foreground whitespace-nowrap">innerhalb von 3 Tagen</div>
              </div>
            </div>
            <div className="flex items-center gap-2.5 sm:gap-3 group">
              <div className="p-2 sm:p-2.5 bg-primary/10 rounded-lg sm:rounded-xl group-hover:bg-primary/15 transition-colors duration-200 flex-shrink-0">
              ...
              <div className="min-w-0">
                <div className="font-semibold text-xs sm:text-sm whitespace-nowrap">Modernste Technik</div>
                <div className="text-[10px] sm:text-xs text-muted-foreground whitespace-nowrap">KI-unterstützt</div>
              </div>
            </div>
            <div className="flex items-center gap-2.5 sm:gap-3 group">
              <div className="p-2 sm:p-2.5 bg-primary/10 rounded-lg sm:rounded-xl group-hover:bg-primary/15 transition-colors duration-200 flex-shrink-0">
              ...
              <div className="min-w-0">
                <div className="font-semibold text-xs sm:text-sm whitespace-nowrap">Facharztstandard</div>
                <div className="text-[10px] sm:text-xs text-muted-foreground whitespace-nowrap">erfahrene Hautärzte</div>
              </div>
            </div>
          </div>
        </div>
