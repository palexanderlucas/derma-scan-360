...
export const FAQ = () => {
  const faqs = [{
    ...
    answer: "Bei Auffälligkeiten erfolgt eine telefonische Befundbesprechung durch einen unserer Ärzte. Hier werden Befund und die weiteren Schritte detailliert mit Ihnen besprochen. Sie erhalten zudem einen Arztbrief mit einer konkreten Handlungsempfehlung. Stellen Sie bitte sicher, dass die nach Ihrer Vorstellung telefonisch erreichbar sind."
  }, {
    ...
    answer: "Die Dauer des Screenings hängt von den individuellen Untersuchungsbedingungen sowie der Anzahl auffälliger Veränderungen ab. In der Regel dauert die eigentliche Untersuchung ca. 30min. Im Einzelfall kann die Dauer hiervon jedoch abweichen. Bitte planen Sie für Ihren gesamten Aufenthalt ca. 45 Minuten ein, da wir vor der Untersuchung noch Gesundheitsfragen erheben."
  }];
